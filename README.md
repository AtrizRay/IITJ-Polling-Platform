...
### Note
Admins and students have different permissions and views. Ensure to select the correct role when logging in. Credentials to login are present in Database file for admin and students.
